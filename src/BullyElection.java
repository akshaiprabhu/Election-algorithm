...
public class BullyElection {
	...
	public static BullyElection be;
	public static ReceiveElectionOne reo; // to receive election messages
	public static ReceiveElectionTwo ret;
	public static ReceiveElectionThree reth;
	public static ReceiveElectionFour ref;
	public static ReceiveIsAliveOne riao; // to receive isAlive Messages
	...
	public BullyElection() {
		...
		IPs.add("129.21.22.196");
		IPs.add("129.21.37.18");
		IPs.add("129.21.37.16");
		IPs.add("129.21.37.15");
		IPs.add("129.21.37.23");
	}
